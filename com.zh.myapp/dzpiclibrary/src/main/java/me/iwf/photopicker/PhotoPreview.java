...
public class PhotoPreview {
    ...
    public static class PhotoPreviewBuilder {
        ...
        public void start2(@NonNull Activity activity, int requestCode) {
            activity.startActivityForResult(getIntent2(activity), requestCode);
        }
        ...
        public void start2(@NonNull Activity activity) {
            start2(activity, REQUEST_CODE);
        }
        ...
        public Intent getIntent2(@NonNull Context context) {
            mPreviewIntent.setClass(context, PhotoPagerActivity2.class);
            mPreviewIntent.putExtras(mPreviewOptionsBundle);
            return mPreviewIntent;
        }
