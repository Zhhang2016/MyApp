...
public class Titlebar extends FrameLayout {
    ...
    private ImageView ivLeft, title_right_pic;
    ...
    public void setTitle(String title, Drawable drawable) {
        ...
        if (drawable == null) {
            ...
            title_right_pic.setVisibility(GONE);
        } else {
            tvTitle.setEnabled(true);
            title_right_pic.setImageDrawable(drawable);
            title_right_pic.setVisibility(VISIBLE);
        }
    }
    ...
    public void setTvRightVisiable(boolean visiable) {
        if (visiable) {
    ...
    private void initView(Context context) {
        ...
        title_right_pic = (ImageView) rootView.findViewById(R.id.title_right_pic);
