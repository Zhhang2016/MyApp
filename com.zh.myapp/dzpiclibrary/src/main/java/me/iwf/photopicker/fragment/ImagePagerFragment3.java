 ...
 */
public class ImagePagerFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.__picker_picker_fragment_image_pager2, container, false);
    ...
    private void runEnterAnimation() {
        ...
        ObjectAnimator colorizer = ObjectAnimator.ofFloat(ImagePagerFragment3.this,
                "saturation", 0, 1);
    ...
    public void runExitAnimation(final Runnable endAction) {
        ...
        ObjectAnimator colorizer =
                ObjectAnimator.ofFloat(ImagePagerFragment3.this, "saturation", 1, 0);
        colorizer.setDuration(duration);
        colorizer.start();
    }
