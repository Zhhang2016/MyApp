package jzwl.com.comzhmyapp.pullfresh;
...
public class HeaderViewRecyclerAdpater extends RecyclerView.Adapter {
    ...
    public HeaderViewRecyclerAdpater(ArrayList<View> headerViewInfos, ArrayList<View> footerViewInfos, RecyclerView.Adapter adapter) {
        ...
        if (mHeaderViewInfos == null) {
            ...
            for (View headerViewInfo : headerViewInfos) {
                ...
                info.viewType = RecyclerView.INVALID_TYPE - 1000 - mHeaderViewInfos.size();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType <= RecyclerView.INVALID_TYPE - 1000) { //Headerview
            return new HeaderViewHolder(mHeaderViewInfos.get(RecyclerView.INVALID_TYPE - 1000 - viewType).view);
        } else if (viewType <= RecyclerView.INVALID_TYPE) { //FooterView
