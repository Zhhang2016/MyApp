...
public final class RSS14Reader extends AbstractRSSReader {
  ...
  private Pair decodePair(BitArray row, boolean right, int rowNumber, Map<DecodeHintType,?> hints) {
    try {
      ...
      com.google.zxing.oned.rss.DataCharacter outside = decodeDataCharacter(row, pattern, true);
      com.google.zxing.oned.rss.DataCharacter inside = decodeDataCharacter(row, pattern, false);
  ...
  private com.google.zxing.oned.rss.DataCharacter decodeDataCharacter(BitArray row, FinderPattern pattern, boolean outsideChar)
    ...
    if (outsideChar) {
      ...
      return new com.google.zxing.oned.rss.DataCharacter(vOdd * tEven + vEven + gSum, checksumPortion);
    } else {
