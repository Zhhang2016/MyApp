...
final class PDF417HighLevelEncoder {
   ...
   */
  static String encodeHighLevel(String msg, com.google.zxing.pdf417.encoder.Compaction compaction, Charset encoding) throws WriterException {
    ...
    if (compaction == com.google.zxing.pdf417.encoder.Compaction.TEXT) {
      encodeText(msg, p, len, sb, textSubMode);

    } else if (compaction == com.google.zxing.pdf417.encoder.Compaction.BYTE) {
