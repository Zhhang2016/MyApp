  ...
  public static void maybeInvokeRetrieval(TextView textView,
    ...
    try {
      if (result instanceof URIParsedResult) {
        com.google.zxing.client.android.result.supplement.SupplementalInfoRetriever uriRetriever =
            new com.google.zxing.client.android.result.supplement.URIResultInfoRetriever(textView, (URIParsedResult) result, historyManager, context);
        uriRetriever.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        com.google.zxing.client.android.result.supplement.SupplementalInfoRetriever titleRetriever =
            new com.google.zxing.client.android.result.supplement.TitleRetriever(textView, (URIParsedResult) result, historyManager);
        ...
        com.google.zxing.client.android.result.supplement.SupplementalInfoRetriever productRetriever =
            new com.google.zxing.client.android.result.supplement.ProductResultInfoRetriever(textView, productID, historyManager, context);
        productRetriever.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
      } else if (result instanceof ISBNParsedResult) {
        String isbn = ((ISBNParsedResult) result).getISBN();
        com.google.zxing.client.android.result.supplement.SupplementalInfoRetriever productInfoRetriever =
            new com.google.zxing.client.android.result.supplement.ProductResultInfoRetriever(textView, isbn, historyManager, context);
        productInfoRetriever.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        com.google.zxing.client.android.result.supplement.SupplementalInfoRetriever bookInfoRetriever =
            new com.google.zxing.client.android.result.supplement.BookResultInfoRetriever(textView, isbn, historyManager, context);
