...
public abstract class ResultHandler {
  ...
  private static final String TAG = com.google.zxing.client.android.result.ResultHandler.class.getSimpleName();
  ...
  final void openProductSearch(String upc) {
    Uri uri = Uri.parse("http://www.google." + LocaleManager.getProductSearchCountryTLD(activity) +
        "/m/products?q=" + upc + "&source=com.google.com.google.com.google.zxing");
