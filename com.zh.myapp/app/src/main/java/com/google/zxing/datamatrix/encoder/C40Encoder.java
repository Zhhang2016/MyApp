...
class C40Encoder implements com.google.zxing.datamatrix.encoder.Encoder {
  ...
  @Override
  public void encode(com.google.zxing.datamatrix.encoder.EncoderContext context) {
    //step C
  ...
  private int backtrackOneCharacter(com.google.zxing.datamatrix.encoder.EncoderContext context,
  ...
  static void writeNextTriplet(com.google.zxing.datamatrix.encoder.EncoderContext context, StringBuilder buffer) {
   ...
   *
   * @param context the encoder activity
   * @param buffer  the buffer with the remaining encoded characters
   */
  void handleEOD(com.google.zxing.datamatrix.encoder.EncoderContext context, StringBuilder buffer) {
    int unwritten = (buffer.length() / 3) * 2;
