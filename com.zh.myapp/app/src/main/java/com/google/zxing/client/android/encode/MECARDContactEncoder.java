 ...
 * @author Sean Owen
 */
final class MECARDContactEncoder extends com.google.zxing.client.android.encode.ContactEncoder {
  ...
  public String[] encode(List<String> names,
    ...
    com.google.zxing.client.android.encode.Formatter fieldFormatter = new MECARDFieldFormatter();
  ...
  private static class MECARDFieldFormatter implements com.google.zxing.client.android.encode.Formatter {
  ...
  private static class MECARDTelDisplayFormatter implements com.google.zxing.client.android.encode.Formatter {
  ...
  private static class MECARDNameDisplayFormatter implements com.google.zxing.client.android.encode.Formatter {
