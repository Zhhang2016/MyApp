...
final class DetectionResult {
  ...
  DetectionResult(com.google.zxing.pdf417.decoder.BarcodeMetadata barcodeMetadata, BoundingBox boundingBox) {
    this.barcodeMetadata = barcodeMetadata;
    this.barcodeColumnCount = barcodeMetadata.getColumnCount();
    this.boundingBox = boundingBox;
    detectionResultColumns = new com.google.zxing.pdf417.decoder.DetectionResultColumn[barcodeColumnCount + 2];
  }
  ...
  private void adjustIndicatorColumnRowNumbers(com.google.zxing.pdf417.decoder.DetectionResultColumn detectionResultColumn) {
    if (detectionResultColumn != null) {
      ((com.google.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn) detectionResultColumn)
  ...
  private int adjustRowNumbers() {
    ...
    for (int barcodeColumn = 1; barcodeColumn < barcodeColumnCount + 1; barcodeColumn++) {
      com.google.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[barcodeColumn].getCodewords();
  ...
  private void adjustRowNumbersFromBothRI() {
    ...
    com.google.zxing.pdf417.decoder.Codeword[] LRIcodewords = detectionResultColumns[0].getCodewords();
    com.google.zxing.pdf417.decoder.Codeword[] RRIcodewords = detectionResultColumns[barcodeColumnCount + 1].getCodewords();
    for (int codewordsRow = 0; codewordsRow < LRIcodewords.length; codewordsRow++) {
      if (LRIcodewords[codewordsRow] != null &&
        ...
        for (int barcodeColumn = 1; barcodeColumn <= barcodeColumnCount; barcodeColumn++) {
          com.google.zxing.pdf417.decoder.Codeword codeword = detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
          if (codeword == null) {
            continue;
          }
  ...
  private int adjustRowNumbersFromRRI() {
    ...
    com.google.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[barcodeColumnCount + 1].getCodewords();
    for (int codewordsRow = 0; codewordsRow < codewords.length; codewordsRow++) {
      if (codewords[codewordsRow] == null) {
        continue;
      }
  ...
  private int adjustRowNumbersFromLRI() {
    ...
    int unadjustedCount = 0;
    com.google.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[0].getCodewords();
    for (int codewordsRow = 0; codewordsRow < codewords.length; codewordsRow++) {
      if (codewords[codewordsRow] == null) {
        continue;
      }
  ...
  private static int adjustRowNumberIfValid(int rowIndicatorRowNumber, int invalidRowCounts, com.google.zxing.pdf417.decoder.Codeword codeword) {
    if (codeword == null) {
  ...
  private void adjustRowNumbers(int barcodeColumn, int codewordsRow, com.google.zxing.pdf417.decoder.Codeword[] codewords) {
    com.google.zxing.pdf417.decoder.Codeword codeword = codewords[codewordsRow];
    com.google.zxing.pdf417.decoder.Codeword[] previousColumnCodewords = detectionResultColumns[barcodeColumn - 1].getCodewords();
    com.google.zxing.pdf417.decoder.Codeword[] nextColumnCodewords = previousColumnCodewords;
    if (detectionResultColumns[barcodeColumn + 1] != null) {
      nextColumnCodewords = detectionResultColumns[barcodeColumn + 1].getCodewords();
    }

    com.google.zxing.pdf417.decoder.Codeword[] otherCodewords = new com.google.zxing.pdf417.decoder.Codeword[14];
    ...
    for (com.google.zxing.pdf417.decoder.Codeword otherCodeword : otherCodewords) {
   ...
   */
  private static boolean adjustRowNumber(com.google.zxing.pdf417.decoder.Codeword codeword, com.google.zxing.pdf417.decoder.Codeword otherCodeword) {
  ...
  void setDetectionResultColumn(int barcodeColumn, com.google.zxing.pdf417.decoder.DetectionResultColumn detectionResultColumn) {
    detectionResultColumns[barcodeColumn] = detectionResultColumn;
  }

  com.google.zxing.pdf417.decoder.DetectionResultColumn getDetectionResultColumn(int barcodeColumn) {
    return detectionResultColumns[barcodeColumn];
  }

  @Override
  public String toString() {
    com.google.zxing.pdf417.decoder.DetectionResultColumn rowIndicatorColumn = detectionResultColumns[0];
