...
public final class Encoder {
   ...
   */
  public static com.google.zxing.aztec.encoder.AztecCode encode(byte[] data) {
   ...
   * @return Aztec symbol matrix with metadata
   */
  public static com.google.zxing.aztec.encoder.AztecCode encode(byte[] data, int minECCPercent, int userSpecifiedLayers) {
    // High-level encode
    ...
    com.google.zxing.aztec.encoder.AztecCode aztec = new AztecCode();
