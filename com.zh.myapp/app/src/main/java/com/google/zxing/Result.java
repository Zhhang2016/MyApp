...
public final class Result {
  ...
  public void addResultPoints(com.google.zxing.ResultPoint[] newPoints) {
    com.google.zxing.ResultPoint[] oldPoints = resultPoints;
    if (oldPoints == null) {
      resultPoints = newPoints;
    } else if (newPoints != null && newPoints.length > 0) {
      com.google.zxing.ResultPoint[] allPoints = new ResultPoint[oldPoints.length + newPoints.length];
