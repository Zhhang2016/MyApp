 ...
 * a URL, or an e-mail address. {@link com.google.zxing.client.result.ResultParser#parseResult(Result)} will turn a raw
...
public abstract class ParsedResult {
  ...
  protected ParsedResult(com.google.zxing.client.result.ParsedResultType type) {
    this.type = type;
  }
