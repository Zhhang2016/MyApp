...
public final class FinderPattern extends ResultPoint {
   ...
   * based on count.
   */
  com.google.zxing.qrcode.detector.FinderPattern combineEstimate(float i, float j, float newModuleSize) {
    ...
    return new com.google.zxing.qrcode.detector.FinderPattern(combinedX, combinedY, combinedModuleSize, combinedCount);
  }
