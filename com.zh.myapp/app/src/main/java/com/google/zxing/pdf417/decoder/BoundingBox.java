...
final class BoundingBox {
  ...
  static com.google.zxing.pdf417.decoder.BoundingBox merge(com.google.zxing.pdf417.decoder.BoundingBox leftBox, com.google.zxing.pdf417.decoder.BoundingBox rightBox) throws NotFoundException {
    if (leftBox == null) {
      return rightBox;
    }
    if (rightBox == null) {
    ...
    return new com.google.zxing.pdf417.decoder.BoundingBox(leftBox.image, leftBox.topLeft, leftBox.bottomLeft, rightBox.topRight, rightBox.bottomRight);
  }

  com.google.zxing.pdf417.decoder.BoundingBox addMissingRows(int missingStartRows, int missingEndRows, boolean isLeft) throws NotFoundException {
    ...
    calculateMinMaxValues();
    return new com.google.zxing.pdf417.decoder.BoundingBox(image, newTopLeft, newBottomLeft, newTopRight, newBottomRight);
  }
