...
/**
 * Handles the result of barcode decoding in the activity of the Android platform, by dispatching the
...
public final class ResultButtonListener implements View.OnClickListener {
  private final com.google.zxing.client.android.result.ResultHandler resultHandler;
