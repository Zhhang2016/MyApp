...
public final class ProductResultParser extends com.google.zxing.client.result.ResultParser {
  ...
  public com.google.zxing.client.result.ProductParsedResult parse(com.google.zxing.Result result) {
    com.google.zxing.BarcodeFormat format = result.getBarcodeFormat();
    if (!(format == com.google.zxing.BarcodeFormat.UPC_A || format == com.google.zxing.BarcodeFormat.UPC_E ||
          format == com.google.zxing.BarcodeFormat.EAN_8 || format == com.google.zxing.BarcodeFormat.EAN_13)) {
      return null;
    }
    ...
    if (format == com.google.zxing.BarcodeFormat.UPC_E && rawText.length() == 8) {
