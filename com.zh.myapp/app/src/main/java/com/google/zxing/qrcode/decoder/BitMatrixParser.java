...
final class BitMatrixParser {
   ...
   */
  com.google.zxing.qrcode.decoder.FormatInformation readFormatInformation() throws FormatException {
    ...
    parsedFormatInfo = com.google.zxing.qrcode.decoder.FormatInformation.decodeFormatInformation(formatInfoBits1, formatInfoBits2);
    if (parsedFormatInfo != null) {
      return parsedFormatInfo;
    }
    throw FormatException.getFormatInstance();
  ...
  byte[] readCodewords() throws FormatException {
    ...
    com.google.zxing.qrcode.decoder.FormatInformation formatInfo = readFormatInformation();
