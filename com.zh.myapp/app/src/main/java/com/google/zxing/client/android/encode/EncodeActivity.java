...
public final class EncodeActivity extends Activity {
  ...
  private static final String TAG = com.google.zxing.client.android.encode.EncodeActivity.class.getSimpleName();

  private static final int MAX_BARCODE_FILENAME_LENGTH = 24;
  private static final Pattern NOT_ALPHANUMERIC = Pattern.compile("[^A-Za-z0-9]");
  private static final String USE_VCARD_KEY = "USE_VCARD";

  private com.google.zxing.client.android.encode.QRCodeEncoder qrCodeEncoder;
  ...
  private void share() {
    com.google.zxing.client.android.encode.QRCodeEncoder encoder = qrCodeEncoder;
    if (encoder == null) { // Odd
  ...
  protected void onResume() {
    ...
    try {
      ...
      qrCodeEncoder = new com.google.zxing.client.android.encode.QRCodeEncoder(this, intent, smallerDimension, useVCard);
