...
final class DetectionResultRowIndicatorColumn extends com.google.zxing.pdf417.decoder.DetectionResultColumn {
  ...
  com.google.zxing.pdf417.decoder.BarcodeMetadata getBarcodeMetadata() {
    com.google.zxing.pdf417.decoder.Codeword[] codewords = getCodewords();
    com.google.zxing.pdf417.decoder.BarcodeValue barcodeColumnCount = new com.google.zxing.pdf417.decoder.BarcodeValue();
    com.google.zxing.pdf417.decoder.BarcodeValue barcodeRowCountUpperPart = new com.google.zxing.pdf417.decoder.BarcodeValue();
    com.google.zxing.pdf417.decoder.BarcodeValue barcodeRowCountLowerPart = new com.google.zxing.pdf417.decoder.BarcodeValue();
    com.google.zxing.pdf417.decoder.BarcodeValue barcodeECLevel = new com.google.zxing.pdf417.decoder.BarcodeValue();
    ...
    com.google.zxing.pdf417.decoder.BarcodeMetadata barcodeMetadata = new com.google.zxing.pdf417.decoder.BarcodeMetadata(barcodeColumnCount.getValue()[0],
        barcodeRowCountUpperPart.getValue()[0], barcodeRowCountLowerPart.getValue()[0], barcodeECLevel.getValue()[0]);
    removeIncorrectCodewords(codewords, barcodeMetadata);
    return barcodeMetadata;
  }

  private void removeIncorrectCodewords(com.google.zxing.pdf417.decoder.Codeword[] codewords, com.google.zxing.pdf417.decoder.BarcodeMetadata barcodeMetadata) {
    // Remove codewords which do not match the metadata
    // TODO Maybe we should keep the incorrect codewords for the start and end positions?
    for (int codewordRow = 0; codewordRow < codewords.length; codewordRow++) {
      com.google.zxing.pdf417.decoder.Codeword codeword = codewords[codewordRow];
